...
describe UserController do  
  ...
  describe "GET 'update'" do
    it "should save the user's person names" do
  ...
  describe "GET 'change_password'" do
    it "should get change password action" do
  ...
  describe "GET 'select_user'" do 
    it "should get the select user action" do
      get :search_user
      response.should be_success
    end
  ...
  describe "GET 'logout'" do
    it "should get the log_out action" do
      get :logout
      session[:user] = nil
  ...
  describe "GET 'signup'" do
    it "should get the signup action" do
      get :signup
      response.should be_success
    end
  end
  ...
  describe "GET 'user_menu'" do
    it "should get the user_menu action" do
      get :user_menu
      response.should be_success
    end
  end
